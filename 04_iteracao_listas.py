...
# No entando, frequentemente precisamos exibir, além do valor
# do elemento, também sua posição. Nesse caso, devemos usar 
# a função for..in combinada com as funções range() e len()
